import { Controller, Body, Param, Get, Post, Delete, Patch, Put, Query } from '@nestjs/common';
...
export class TaskController {
    ...
    @ApiOperation({
        ...
        description: 'Obtiene una lista de todas las tareas registradas en el sistema, opcionalmente filtradas por estado'
    })
    @ApiParam({
        name: 'id',
    ...
    getAllTasks(
        @Param('id') id: string,
        @Query('state') state?: 'pending' | 'in_progress' | 'completed'
    ) {
        return this.taskService.getAllTasksByUser(id, state);
    }
